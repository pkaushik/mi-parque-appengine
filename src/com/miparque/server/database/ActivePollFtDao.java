...
public class ActivePollFtDao extends AbstractFtDao<ActivePoll, String> {
    /* private final static String COLUMNS = "ROWID,title,description,multiple,first,ogurl,ogimage_url," +
     ...
     private final static String COLUMNS = 
             "ROWID,pollid,title,description,multiple,first,ogurl,ogimage_url,"
             + "choiceid0,index0,choice0,details0,cogurl0,cogimage_url0,"
             + "choiceid1,index1,choice1,details1,cogurl1,cogimage_url1,"
             + "choiceid2,index2,choice2,details2,cogurl2,cogimage_url2,"
             + "choiceid3,index3,choice3,details3,cogurl3,cogimage_url3,"
             + "choiceid4,index4,choice4,details4,cogurl4,cogimage_url4";
    ...
    protected String getInsertSql(ActivePoll entity) {
        ...
        StringBuffer sb = new StringBuffer("insert into ")
                .append(FID)
                .append(" (")
                .append("pollid,title,description,multiple,first,ogurl,ogimage_url,")
                .append("choiceid0,index0,choice0,details0,cogurl0,cogimage_url0,")
                .append("choiceid1,index1,choice1,details1,cogurl1,cogimage_url1,")
                .append("choiceid2,index2,choice2,details2,cogurl2,cogimage_url2,")
                .append("choiceid3,index3,choice3,details3,cogurl3,cogimage_url3,")
                .append("choiceid4,index4,choice4,details4,cogurl4,cogimage_url4")
                .append(") values (")
                .append(nullSafeString(entity.getPollId()))
                .append(",")
        ...
        for (int i = 0; i < 5; i++) {
            sb.append(",")
                .append(nullSafeString(entity.getChoiceId(i)))
                .append(",")
    ...
    protected ActivePoll mergeFromMap(Map<String, String> m) {
        ...
        if (m.containsKey("pollid")) { ap.setPollId(m.get("pollid")); }
        ...
        if (m.containsKey("choiceid0")) { ap.setChoice(m.get("choiceid0"), 0); }
        ...
        if (m.containsKey("choiceid1")) { ap.setChoice(m.get("choiceid1"), 1); }
        ...
        if (m.containsKey("choiceid2")) { ap.setChoice(m.get("choiceid2"), 2); }
        ...
        if (m.containsKey("choiceid3")) { ap.setChoice(m.get("choiceid3"), 3); }
        ...
        if (m.containsKey("choiceid4")) { ap.setChoice(m.get("choiceid4"), 4); }
